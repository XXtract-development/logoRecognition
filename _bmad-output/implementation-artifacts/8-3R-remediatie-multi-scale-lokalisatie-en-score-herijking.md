...
Status: review — implementatie + tests compleet; AC4-gate BLOCKED door corrupte fase-B-ground-truth (zie `8-3R-meetrapport.md`), besluit gebruiker vereist
...
- AC4 (empirische validatie): script + meetrapport opgeleverd; **gate 4/9 = BLOCKED** — kruisproef bewijst 5/9 corrupte ground-truth-items (1 mislabel: FSC-label met EU_ORGANIC-inhoud 0,914; 4 vrijwel witte crops, mean ≥250). Engine: 4/4 op valide items; kalibratie-advies stap 1,10 + drempel 0,55; eerste natuurlijke detectie (RAINFOREST op Theunisse-koffie, 0,67)
