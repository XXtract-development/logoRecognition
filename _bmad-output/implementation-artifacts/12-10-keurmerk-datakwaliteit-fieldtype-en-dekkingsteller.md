...
- [ ] 7. **ACC-toepassing + verificatie (AC: 6, permission-gated)** — NIET uitgevoerd in deze run (geen expliciete toestemming Friso). Blijft open: live ACC-diagnose, `--apply`-backfill, deploy, na-verificatie.
